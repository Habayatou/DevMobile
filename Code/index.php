...
if(isset($_POST['login']))
{
    ...
    $sth = $dbconn->prepare("SELECT id FROM country WHERE email=:email AND password=:password");
    $sth->bindParam(':email', $countryEmail);
    ...
    if($result) {
        ...
        header('location: pages/realizing.php');
        exit; // Important: Terminates the current script execution to prevent further execution
    } else {
